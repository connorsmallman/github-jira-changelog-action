...
const source = new _SourceControl.default((0, _Config.getDefaultConfig)());
/**
 * Test git log graph:
 *
   *    1
...
describe('Decorate reverts', () => {
  ...
  test('Commit messages are not combined from reverted commits.', () => {
    ...
    rev2b.fullText = 'Revert "Foo bar commit"\nThis reverts commit b71e882870a04fa35b77031f06b1edbdb6acb21c.'; // Generate combined commit messages

    const graph = source.simpleTopLevelGraph(testGitLogs);
    const combinedMessages = source.consolodateCommitMessages(graph); // Rev 2b should not be inlcuded
...
//# sourceMappingURL=SourceControl.test.js.map